...
#Add your code here!
def is_a_contender(name,wins,loss):
    if wins >= 40 and loss < 20:
        return "The"+ ' '+str(name)+' '+"are a contender!"
    if wins < 40 and loss >= 20:
        return "The"+ ' '+str(name)+' '+"are not a contender!"   
    if wins > 40 and loss > 20:
        return "The"+ ' '+str(name)+' '+"might be a contender!"
    if wins < 40 and loss < 20:
        return "The"+ ' '+str(name)+' '+"might be a contender!"
